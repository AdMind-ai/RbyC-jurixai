...
const ChatMessageList: React.FC<ChatMessageListProps> = ({ messages, isTyping, isOverview, setMessages }) => {
          ...
          return (
            <Box key={idx} display="flex" justifyContent={msg.sender === 'user' ? 'flex-end' : 'flex-start'} mb={0.5}>
              ...
              >
                ...
                {/* Markdown Content */}
                <Typography component="div" sx={{ whiteSpace: 'pre-wrap', fontSize:'1rem', padding: 0, pb:4 }}>
                  <ReactMarkdown 
                  ...
                  {msg.sender === 'ai' && (
                    ...
                    >
                      ...
                      >
                        <img src={copyIcon} alt="Copy" style={{height:'20px', width:'20px'}} />
                      </IconButton>
                    </Box>
                  )}
                </Typography>
        ...
        { messages.length !== 0 && (
          <Button
            ...
            sx={{
              ...
              textTransform:'none', width:'250px', fontSize:'17px'
            }}
          >
