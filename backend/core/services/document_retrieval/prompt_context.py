...
def build_document_search_input(
    ...
    return (
        ...
        "e indicazione chiara sul fatto che questa approvazione possa riferirsi "
        "a una versione precedente o a modifiche collegate, non necessariamente "
        "al documento piu recente. "
