...
OPENAI_PROMPT_ID_RBYC = os.environ.get('OPENAI_PROMPT_ID_RBYC')
VECTOR_STORE_ID_RBYC = os.environ.get('VECTOR_STORE_ID_RBYC')
...
keys = [
    'OPENAI_KEY',
    'DEEPL_KEY',
    'OPENAI_PROMPT_ID_RBYC',
    'VECTOR_STORE_ID_RBYC',
